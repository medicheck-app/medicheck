...
- **Bug fixes (17 Mai 2026):** `nameSimilarity()` com peso posicional; `saveToDrive()` valida integridade antes de sync; `_saveIntervalId` guarda ID do intervalo (commit 5502de1)
